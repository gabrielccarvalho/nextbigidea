...
// renders NO data at all — the cards are decorative skeletons and the only
// real number shown is the count of locked ideas. Keep it that way.
      ...
      <div aria-hidden className="grid gap-4 sm:grid-cols-2">
        {CARD_SHAPES.map((widths, i) => (
          <div key={i} className="rounded-lg border p-4">
            <div className={`h-3 ${widths[0]} rounded bg-foreground/10 blur-[2px]`} />
            <div className={`mt-2 h-4 ${widths[1]} rounded bg-foreground/15 blur-[2px]`} />
